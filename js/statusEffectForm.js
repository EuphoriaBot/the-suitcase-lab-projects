        ...
        <div class="form-page">
            ...
            : "Add Status Effect"
                    ...
                    <p class="page-description">
                        ${existingStatusEffect
            ? "Update this status effect's information."
            : "Record a Reverse: 1999 status effect."
        }
                    </p>
            ...
            existingStatusEffect?.name ?? ""
                    ...
                    <div class="form-group">
                        ...
                        <label for="status-effect-category">
                            Category
                        </label>

                        <input
                            type="text"
                            id="status-effect-category"
                            name="category"
                            placeholder="e.g. Negative"
                            value="${escapeHtml(
            existingStatusEffect?.category ?? ""
        )}"
                            required
                        >
                    ...
                    <div class="form-group">
                        ...
                        >${escapeHtml(
            existingStatusEffect?.description ?? ""
        )}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <label class="checkbox-label">
                                ...
                                <input
                                    ...
                                    name="stackable"
                                    ${existingStatusEffect?.stackable
            ? "checked"
            : ""
        }
                                >
            ...
            existingStatusEffect
                ...
                <div class="form-section">
                    ...
                    <p class="form-help">
                        Select the mechanics related to this status effect.
                    </p>
        ...
        .map(arcanist => `
            ...
            <label class="relationship-item">
                ...
                <input
                    ...
                    value="${escapeHtml(arcanist.id)}"
                    ${selectedIds.includes(arcanist.id)
                ? "checked"
                : ""
            }
                >
        ...
        .map(mechanic => `
            ...
            <label class="relationship-item">
                ...
                <input
                    type="checkbox"
                    class="relationship-checkbox"
                    name="related-mechanic"
                    value="${escapeHtml(mechanic.id)}"
                    ${selectedIds.includes(mechanic.id)
                ? "checked"
                : ""
            }
                >
