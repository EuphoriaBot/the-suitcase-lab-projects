...
export function renderStatusEffectForm(
    ...
    container.innerHTML = `
        <div class="form-page">
                ...
                <section class="form-section">
                    ...
                    <div class="form-section-heading">
                        ...
                        <div>
                            ...
                            <p>
                                Core information about this status effect.
                            </p>
                ...
                <section class="form-section">
                    ...
                    <div class="form-section-heading">
                        ...
                        <div>
                            ...
                            <p>
                                Select the Arcanists associated with this status effect.
                            </p>
            ...
            arcanists,
            existingStatusEffect?.relatedArcanists ?? []
        )}
    ...
    form.addEventListener(
        ...
        event => {
            ...
            if (existingStatusEffect) {
                ...
                if (!updatedStatusEffect) {

                    showToast(
                        "Unable to update Status Effect.",
                        "error"
                    );
                ...
                showToast(
                    "Status Effect updated successfully."
                );
